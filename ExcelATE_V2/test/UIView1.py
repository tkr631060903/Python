...
class UIViewClass(UIDataClass, QMainWindow):
    ...
    def test(self):
        self.testQThread.start()
        self.diode_thdOnOFF = True
    ...
    def initUI(self):
        ...
        # self.btn.clicked.connect(self.testResConfig())
    ...
    def testInitConfig(self):
        ...
        # self.diode_volLen.setMaxLength(3)
        ...
        # self.diode_currExpectLen.close()
        ...
        # self.diode_currExpectComboBox.close()
